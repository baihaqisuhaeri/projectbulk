...
class Verifikasi_sj_model extends CI_Model
{
    ...
    public function edit_verifikasi_sj($id, $data)
    {
        $this->db->where('id', $id);
    ...
    public function edit_sj_setelah_dihapus($no_sj, $btl_sj, $data)
    {
        $this->db->where('no_sj', $no_sj);
        $this->db->where('btl_sj', $btl_sj);
        $this->db->update('tb_sj', $data);
    ...
    public function hapus_alamat_kirim($id)
    {
        $this->db->where('id', $id);
        $this->db->delete($this->tableAlamat);
    }

    public function edit_alamat_kirim($id, $data)
    {
        $this->db->where('id', $id);
